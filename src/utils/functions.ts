...
export const openMultipleCells = (
    ...
    if (
        topLeftCell?.state === CellState.dontTouched &&
    ...
    if (
        topCell?.state === CellState.dontTouched &&
    ...
    if (
        topRightCell?.state === CellState.dontTouched &&
    ...
    if (
        leftCell?.state === CellState.dontTouched &&
    ...
    if (
        rightCell?.state === CellState.dontTouched &&
    ...
    if (
        bottomLeftCell?.state === CellState.dontTouched &&
    ...
    if (
        bottomCell?.state === CellState.dontTouched &&
    ...
    if (
        bottomRightCell?.state === CellState.dontTouched &&
